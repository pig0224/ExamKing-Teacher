    ...
    <el-table v-loading="listLoading"
      ...
      <el-table-column width="150px"
        ...
        <template slot-scope="{row}">
          <router-link :to="{path:'/question/judge-edit', query:{id:row.id}}"
                       class="link-left">
...
import judgeApi from '@/api/question'
...
export default {
  ...
  methods: {
    async search() {
      ...
      await judgeApi.judges(this.queryParam).then(({ data }) => {
